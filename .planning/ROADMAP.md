...
### Phase 01.1: Block-based lesson display with per-block navigation and module progress tracker (INSERTED)
...
- [ ] 01.1-02-PLAN.md — Navigator refactor: two-level part loop, new key bindings (w/q/e/esc), entry point wiring, and interactive verification
